...
const NAV = [
  ...
  { to: "/builder", label: "Test Builder", icon: Wrench, tid: "nav-builder" },
  { to: "/suites", label: "Test Suites", icon: Layers, tid: "nav-suites" },
  ...
  { to: "/test-data", label: "Test Data", icon: Database, tid: "nav-testdata" },
